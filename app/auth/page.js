...
export default function AuthPage() {
  ...
  return (
    <div className="flex flex-col py-[100px] justify-center lg:flex lg:flex-row lg:justify-between lg:py-0 h-screen items-center max-w-md md:max-w-2xl lg:max-w-5xl  2xl:max-w-7xl mx-auto lekton lg:pr-[53px] gap-[80px]">
      ...
      <div className='left-side px-[25px] lg:px-[0px]  w-[100%] lg:max-w-[416]'>
        <h1 className='text-[35px] lg:text-[45px] lekton font-[700] '>{isLogin ? "Hisobga kirish": "Ro'yxatdan o'tish"}</h1>
        {error && (
        ...
        <form className='form mt-[48px]' onSubmit={handleSubmit} >
          <div className='email flex flex-col'>
            ...
            <input value={email}  onChange={(e)=>setEmail(e.target.value)} id='email' className='w-[100%] lg:w-[416px]  h-[50px] border-1 rounded-[10px]  placeholder:lekton pl-[12px]' placeholder='Emailingizni kiritng...' />
          </div>
          <div className='password flex flex-col mt-[22px]'>
            ...
            <input type='password'  value={password} onChange={(e)=>setPassword(e.target.value)} id='password' className='font-sans w-[100%] lg:w-[416px]  h-[50px] border-1 rounded-[10px]  placeholder:lekton pl-[12px]' placeholder='Parolinigzni kiritng...' />
          </div>
